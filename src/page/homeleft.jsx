...
import black from "../images/d.jpg"
                  ...
                  <div className="flex items-center w-full pr-3">
                    ...
                    <div className="flex flex-col justify-between border-b border-b-[#222d34] py-3 w-full">
                      <div>
                        ...
                        <h1 className="text-[#e3e7e5] font-bold">BLACK SUN</h1>
                        <p className='text-[#89a7a1]'>13:34</p>
                        </div>

                        <div className='flex justify-between items-center'>
                          <div className='flex items-center'>
                            <BsCheck2All color='#53bdeb' size={20} className="mr-1"/>
                            <p className="text-[#869695]">Did you see the sunrise?</p>
                          </div>
                        </div>
                      </div>
                    </div>
